...
import { delePostResponse, deletePost, getPost, getPosts, getPostsResponses, patchPost, patchPostResponse, postPosts, postPostsResponses, } from "../controllers/postsController.js";
...
postRouter.patch("/:postId/responses/:responseId", checkToken, patchPostResponse);
postRouter.delete("/:postId/responses/:responseId", checkToken, delePostResponse);
