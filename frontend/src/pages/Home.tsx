...
export function Home() {
  ...
  const { onLargeScreen, onPageTransition, onSmallScreen } =
  ...
  return (
    <div
      ...
      className={`${onLargeScreen && "ml-60"} flex items-start border-l border-gray-100`}
    >
      ...
      {!onSmallScreen && (
        <div className="w-1/3 border-l border-gray-100  pt-10 pl-10 sticky top-10 self-start">
